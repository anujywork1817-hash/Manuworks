        ...
        child: Column(children: [
          ...
          Expanded(
            child: docsAsync.when(
              ...
              error: (_, __) => _EmptyState(onChat: () => context.go('/ai-chat/general')),
              data: (docs) {
                if (docs.isEmpty) {
                  return _EmptyState(onChat: () => context.go('/ai-chat/general'));
                }
...
class _EmptyState extends StatelessWidget {
  ...
  const _EmptyState({required this.onChat});
  ...
  Widget build(BuildContext context) {
    ...
    return Center(child: Padding(
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        Text(
          'Ask the AI anything, or open a document\nfrom Docs to chat with it directly.',
